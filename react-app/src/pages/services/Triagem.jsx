        ...
        <div className="bg-white rounded-lg shadow-md border border-neutral-200 mb-6">
          ...
          <div className="p-4 sm:p-6">
            <p className="text-neutral-700 leading-relaxed mb-5 text-sm">
              Na Unidade básica de saúde do bairro São José, o acolhimento e a
              triagem de enfermagem são etapas fundamentais do cuidado em saúde.
              Embora complementares, cada uma possui um papel específico no
              atendimento ao usuário, sempre com foco no respeito, na escuta e
              na segurança clínica.
            </p>
            <p className="text-neutral-700 leading-relaxed mb-5 text-sm">
              O objetivo é garantir que todas as pessoas sejam recebidas com
              atenção, orientadas corretamente e avaliadas conforme suas
              necessidades, assegurando prioridade aos casos que exigem maior
              urgência.
            </p>
            <div className="space-y-4 mb-5">
              <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
                ...
                <p className="text-sm text-neutral-700 leading-relaxed mb-2">
                  O acolhimento é o primeiro contato do usuário com a unidade.
                  Neste momento, a equipe realiza uma escuta qualificada,
                  compreendendo a queixa apresentada e orientando sobre o fluxo
                  de atendimento disponível.
                </p>
                <p className="text-sm text-neutral-700 leading-relaxed">
                  Mais do que um procedimento, o acolhimento é uma prática
                  humanizada, que valoriza o diálogo, o respeito e o vínculo
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
                ...
                <p className="text-sm text-neutral-700 leading-relaxed">
                  A triagem de enfermagem é uma avaliação clínica inicial
                  realizada por profissional de enfermagem capacitado. Seu
                  objetivo é identificar sinais e sintomas, avaliar a gravidade
                  do quadro e definir a prioridade de atendimento conforme
                  protocolos estabelecidos.
                </p>
                <p className="text-sm text-neutral-700 leading-relaxed mt-2">
                  A triagem não garante consulta médica imediata, mas assegura
                  que cada caso seja direcionado ao serviço mais adequado, com
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
                  ...
                  <tbody className="text-sm">
                    <tr className="bg-white">
                      ...
                      <td className="border border-neutral-300 px-4 py-3 text-neutral-700">
                        Verificação de pressão arterial, temperatura corporal,
                        frequência cardíaca e respiratória, conforme protocolos
                        de enfermagem.
                      </td>
                    </tr>
                    <tr className="bg-white">
                      ...
                      <td className="border border-neutral-300 px-4 py-3 text-neutral-700">
                        Medição para atualização do prontuário e cálculo de
                    ...
                    <tr className="bg-white">
                      ...
                      <td className="border border-neutral-300 px-4 py-3 text-neutral-700">
                        Análise dos sintomas apresentados para definição da
                        prioridade e do encaminhamento adequado.
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div className="md:hidden space-y-4">
                <div className="bg-white border border-neutral-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-neutral-700 leading-relaxed">
                    Verificação de pressão arterial, temperatura corporal,
                    frequência cardíaca e respiratória, conforme protocolos de
                    enfermagem.
                  </p>
                </div>
          ...
          <div className="p-4 sm:p-6">
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-neutral-700 text-sm leading-relaxed">
                  Explique sua queixa de forma clara ao profissional de
                  enfermagem
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-neutral-700 text-sm leading-relaxed">
                  Após a avaliação, receba o encaminhamento conforme a
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
                ...
                <ul className="list-disc list-inside text-sm text-neutral-700 mb-3 space-y-1">
                  <li>
                    <strong>Período matutino</strong> de 07h00 às 08h00
                  </li>
                  <li>
                    <strong>Período noturno</strong> de 18h00 às 19h00
                  </li>
                </ul>
                <div className="bg-white/70 border-l-4 border-blue-600 p-3 rounded-r">
                  <p className="text-sm text-neutral-700 leading-relaxed">
                    <strong>Como funciona a Triagem:</strong> A triagem é uma
                    avaliação clínica inicial realizada por profissional de
                    enfermagem qualificado. Este procedimento não garante
                    consulta médica imediata, mas avalia a necessidade e
                    prioridade do atendimento. Conforme a necessidade
                    identificada na triagem, o usuário será encaminhado para a
                    enfermeira responsável ou para o médico da área
                    correspondente, conforme protocolos estabelecidos pela
                    unidade.
                  </p>
                </div>
              </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-white/95 leading-relaxed">
                ...
                recepção da unidade para realização da ficha de atendimento.
                Esta medida é essencial para agilizar o processo de atendimento
                e garantir a organização adequada do fluxo de pacientes na
                unidade.
              </p>
            </div>
          </div>
