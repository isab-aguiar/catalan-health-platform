    ...
    <PageContainer>
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md border border-neutral-200 mb-6">
          ...
          <div className="p-4 sm:p-6">
            <p className="text-neutral-700 text-sm leading-relaxed">
              ...
              prescrições médicas. Este serviço é ideal para quem possui
              condições crônicas controladas, como hipertensão, diabetes e
              outras doenças que exigem tratamento prolongado e acompanhamento
              regular.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="p-4 sm:p-6">
            <p className="text-neutral-700 mb-4 text-sm leading-relaxed">
              É importante conhecer o prazo de validade da sua receita para
              evitar que ela expire antes da renovação. Os prazos variam
              conforme o tipo de medicamento prescrito:
            </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-neutral-800 text-sm leading-relaxed">
                    Verifique sempre a data de emissão da sua receita e planeje
                    a renovação antes do vencimento para garantir a continuidade
                    do tratamento.
                  </p>
                </div>
              </div>
        ...
        <div className="bg-white rounded-lg shadow-md border border-neutral-200 mb-6">
          ...
          <div className="p-4 sm:p-6">
            <p className="text-neutral-700 mb-4 text-sm leading-relaxed">
              Para solicitar a renovação de receitas, é obrigatória a
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-white/95 leading-relaxed">
                ...
                documento de identidade oficial com foto e CPF do titular,
                podendo ser apresentado o documento físico ou o número do CPF.
              </p>
            </div>
          </div>
        </div>
