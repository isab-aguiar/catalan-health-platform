      ...
      <div className="mb-8">
        <div className="bg-white border border-neutral-200 rounded-lg shadow-sm overflow-hidden">
          <div className="bg-neutral-50 border-b border-neutral-200 px-6 py-4">
            ...
            <p className="text-sm text-neutral-600 mt-1">Atendimento de urgência após exposição de risco</p>
          </div>
          ...
          <div className="p-6 space-y-6">
            <div>
              ...
              <ul className="space-y-2 ml-6">
                <li className="text-neutral-700 list-disc">Relação sexual sem preservativo</li>
                <li className="text-neutral-700 list-disc">Falha ou rompimento do preservativo</li>
                <li className="text-neutral-700 list-disc">Violência sexual</li>
                <li className="text-neutral-700 list-disc">Acidente com material biológico</li>
              </ul>
            </div>
            ...
            <div className="border-t border-neutral-200 pt-6">
              <div className="flex items-start gap-3 bg-red-50 border border-red-200 rounded-lg p-4">
                ...
                <div>
                  <h3 className="font-semibold text-red-900 mb-2">Prazo Crítico</h3>
                  <p className="text-neutral-700 leading-relaxed">
      ...
      <div className="mb-8">
        <div className="bg-white border border-neutral-200 rounded-lg shadow-sm overflow-hidden">
          <div className="bg-neutral-50 border-b border-neutral-200 px-6 py-4">
            ...
            <p className="text-sm text-neutral-600 mt-1">Prevenção programada e contínua</p>
          </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="border-t border-neutral-200 pt-6">
              <h3 className="font-semibold text-neutral-900 mb-3">Como funciona?</h3>
              <ul className="space-y-2 ml-6">
                <li className="text-neutral-700 list-disc">Requer cadastro e acompanhamento médico regular</li>
                <li className="text-neutral-700 list-disc">Testagens periódicas de HIV e outras ISTs</li>
                <li className="text-neutral-700 list-disc">Acompanhamento de saúde integral e preventivo</li>
                <li className="text-neutral-700 list-disc">Uso diário da medicação conforme orientação médica</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="mb-8">
        ...
        <div className="bg-white border border-neutral-200 rounded-lg shadow-sm overflow-hidden mb-6">
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="flex items-start gap-3">
              <Clock size={20} className="text-primary-600 mt-0.5 flex-shrink-0" />
              <p className="text-neutral-700">
                <strong className="text-neutral-900">Segunda a Sexta-feira:</strong> 07:00 às 17:00
              </p>
            </div>
          </div>
        </div>
