    ...
    <PageContainer>
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md border border-neutral-200 mb-6">
          ...
          <div className="p-4 sm:p-6">
            <p className="text-neutral-700 leading-relaxed text-sm">
              A recepção é o setor responsável pelo primeiro atendimento ao
              usuário na unidade, realizando o direcionamento adequado aos
              serviços de saúde disponíveis e fornecendo informações sobre o
              funcionamento da unidade, conforme protocolos e normativas
              estabelecidas.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md border border-neutral-200 mb-6">
          ...
          <div className="p-4 sm:p-6">
            <p className="text-neutral-700 mb-4 text-sm">
              Sim. A recepção realiza o direcionamento para os seguintes
              serviços:
            </p>
        ...
        <div className="bg-white rounded-lg shadow-md border border-neutral-200 mb-6">
          ...
          <div className="p-4 sm:p-6">
            <p className="text-neutral-700 mb-4 text-sm">
              ...
              diretamente na recepção, sem necessidade de aguardar na Sala de
              Agendamentos ou na Sala de atendimento administrativo.
            </p>
                ...
                <tbody className="text-sm">
                  <tr className="bg-white">
                    ...
                    <td className="border border-neutral-300 px-4 py-3 text-neutral-700">
                      Receitas de uso contínuo que foram deixadas para renovação
                      e já estão prontas para retirada.
                    </td>
                  </tr>
                  <tr className="bg-white">
                    <td className="border border-neutral-300 px-4 py-3">
                    ...
                    <td className="border border-neutral-300 px-4 py-3 text-neutral-700">
                      Encaminhamentos ou guias que não necessitam de assinatura
                      do usuário.
                    </td>
                  </tr>
                  <tr className="bg-white">
        ...
        <div className="bg-white rounded-lg shadow-md border border-neutral-200 mb-6">
          ...
          <div className="p-4 sm:p-6">
            <p className="text-neutral-700 mb-4 text-sm">
              Para retirar receitas renovadas e exames na recepção, é
              ...
              <div className="flex items-start gap-3 bg-blue-50 p-3 rounded border border-blue-100">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-neutral-600 mt-0.5">
                    ...
                    Habilitação original do titular
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3 bg-blue-50 p-3 rounded border border-blue-100">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-neutral-800 text-sm leading-relaxed">
                      Sem a apresentação desses documentos, não será possível
