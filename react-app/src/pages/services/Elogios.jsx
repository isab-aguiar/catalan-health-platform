    ...
    try {
      ...
      if (result.success) {
        await showModal({
          ...
          message:
            "Obrigado! Seu elogio foi enviado com sucesso. Sua opinião é muito importante para nós!",
          confirmText: "Entendi",
        });
        ...
        await showModal({
          ...
          message:
            result.error ||
            "Ocorreu um erro ao enviar seu elogio. Tente novamente.",
          confirmText: "Fechar",
        });
      }
    } catch (error) {
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-neutral-800 text-sm leading-relaxed">
                Todos os elogios são analisados pela equipe administrativa. Seu
                feedback positivo motiva e valoriza o trabalho de toda a equipe.
              </p>
            </div>
          </div>
        </div>
