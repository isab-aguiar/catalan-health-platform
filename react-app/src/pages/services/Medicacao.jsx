      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white border border-slate-200 rounded-md shadow-sm p-6 mb-6">
          <div className="flex items-center gap-4 mb-2">
            <div>
              <h1 className="text-3xl font-bold text-slate-900">Sala de Medicação</h1>
              <p className="text-slate-600 text-sm mt-1">UBS São José - Unidade Básica de Saúde</p>
            </div>
          </div>
        </div>

        {/* Campanhas específicas da página de medicação */}
        <CampanhasPaginaWrapper pagina="medicacao" />

        {/* Avisos específicos da página de medicação */}
        <AvisosPaginaWrapper pagina="medicacao" />

        {/* Sobre o Serviço */}
        <InfoBox title="Sobre o Serviço">
          <p className="text-slate-700 leading-relaxed mb-5">
            A Sala de Medicação da Unidade Básica de Saúde São José realiza aplicação de medicamentos 
            injetáveis prescritos por médicos, além de outros procedimentos de enfermagem que requerem 
            administração de medicações conforme protocolos estabelecidos.
          </p>
          
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-slate-50 border border-slate-200 rounded p-4">
              <h3 className="font-semibold text-slate-800 mb-2 text-sm">Aplicação de Injeções</h3>
              <p className="text-sm text-slate-600">
                Administração de medicamentos por via intramuscular, subcutânea e endovenosa, 
                conforme prescrição médica.
              </p>
            </div>
            <div className="bg-slate-50 border border-slate-200 rounded p-4">
              <h3 className="font-semibold text-slate-800 mb-2 text-sm">Administração de Medicamentos</h3>
              <p className="text-sm text-slate-600">
                Aplicação de medicações conforme prescrição médica e protocolos de segurança estabelecidos.
              </p>
            </div>
            <div className="bg-slate-50 border border-slate-200 rounded p-4">
              <h3 className="font-semibold text-slate-800 mb-2 text-sm">Nebulização</h3>
              <p className="text-sm text-slate-600">
                Tratamento de problemas respiratórios mediante administração de medicamentos por via inalatória.
              </p>
            </div>
            <div className="bg-slate-50 border border-slate-200 rounded p-4">
              <h3 className="font-semibold text-slate-800 mb-2 text-sm">Aferição de Sinais Vitais</h3>
              <p className="text-sm text-slate-600">
                Verificação de sinais vitais realizada de forma sistemática para controle ou conforme 
                demanda e necessidade clínica do paciente.
              </p>
            </div>
          </div>
        </InfoBox>
            ...
            <table className="w-full border-collapse border border-slate-300">
              ...
              <tbody className="text-sm">
                <tr className="bg-white">
                  ...
                  <td className="border border-slate-300 px-4 py-3 text-slate-600">Atendimento livre</td>
                </tr>
        ...
        <InfoBox title="Documentação Necessária" variant="highlight">
          <p className="text-slate-700 mb-4 text-sm">
            Para atendimento na sala de medicação, é obrigatória a apresentação da seguinte documentação:
          </p>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-start gap-3 bg-white p-3 rounded border border-slate-200">
              <div className="w-1.5 h-1.5 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
              <div className="flex-1">
                <strong className="text-slate-800 text-sm">Prescrição Médica</strong>
                <p className="text-xs text-slate-600 mt-0.5">Obrigatória para aplicação de medicamentos</p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-blue-700 text-white rounded-md p-5 shadow-sm">
          <div>
            ...
            <p className="text-sm text-blue-50 leading-relaxed">
              Traga sempre a prescrição médica original e o medicamento prescrito. Não esqueça de 
              passar pela recepção primeiro para realizar sua ficha de atendimento.
            </p>
          </div>
        </div>
      </div>
