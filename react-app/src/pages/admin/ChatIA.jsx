...
// PÁGINA CHAT IA
// =========================================
// Interface do chat com IA para criar avisos
...
export default function ChatIA() {
  ...
  const handleCreateAviso = async (avisoData) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Opcional: redirecionar para página de avisos
  ...
  // Abrir modal para editar antes de salvar
      ...
      <div className="max-w-7xl mx-auto h-full flex flex-col">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-xl font-bold text-slate-900">Assistente Inteligente</h1>
              <p className="text-xs text-slate-600">Geração automatizada de avisos e campanhas</p>
            </div>
          </div>
              ...
              <>
                ...
                <div className="absolute right-0 top-full mt-2 w-80 bg-white border border-slate-200 rounded-lg shadow-xl z-20 p-4">
                  <div className="flex items-start gap-2 mb-3">
                    ...
                    <h3 className="font-semibold text-slate-900 text-sm">Orientações de Uso</h3>
                  </div>
                  <ul className="text-xs text-slate-700 space-y-1.5 list-disc list-inside">
                    <li>Descreva de forma clara o aviso ou anexe uma imagem</li>
                    <li>Especifique material, vacina ou campanha</li>
                    <li>O sistema gera comunicado profissional automaticamente</li>
        ...
        {/* Chat Container - Altura Fixa ~600px */}
        <div className="bg-white rounded-lg shadow-sm border border-neutral-200 overflow-hidden" style={{ height: '600px' }}>
          <ChatBot
