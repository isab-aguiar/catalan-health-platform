            ...
            <div className="flex items-center gap-2 sm:gap-3">
              {permissions.canCreateAvisos() && (
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-3 sm:px-4 py-2 bg-blue-600 hover:bg-info-700 text-white rounded-md transition-colors font-medium text-xs sm:text-sm border border-blue-700 shadow-sm w-full sm:w-auto"
                >
                  <Plus className="w-4 h-4" />
                  <span>Cadastrar Aviso</span>
                </button>
              )}
            </div>
          </div>
