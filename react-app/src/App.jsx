...
const FarmaciaDispensacao = lazyLoad(
  () => import("./pages/services/FarmaciaDispensacao")
);
...
const OrientacoesPosConsulta = lazyLoad(
  () => import("./pages/admin/OrientacoesPosConsulta")
);
...
const OuvidoriaIndex = lazyLoad(
  () => import("./pages/services/OuvidoriaIndex")
);
