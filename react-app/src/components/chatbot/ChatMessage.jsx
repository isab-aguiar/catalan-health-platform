...
export default function ChatMessage({
  ...
  const handleInputSubmit = (e) => {
    ...
    console.log("📤 Enviando input:", {
      value,
      field: message.inputField?.field,
            ...
            >
              ...
              <div className="p-3 space-y-1.5">
                ...
                <div className="pt-2 space-y-1 border-t border-neutral-200">
                  {(message.campanhaData.dataInicio ||
                    message.campanhaData.dataFim) && (
                    <div className="flex items-start gap-1">
                      ...
                      <span className="text-[10px] text-neutral-600">
                        ...
                        {message.campanhaData.dataFim &&
                          ` até ${new Date(message.campanhaData.dataFim).toLocaleDateString("pt-BR")}`}
                      </span>
                    </div>
                  )}
                  ...
                  {message.campanhaData.topicos &&
                    message.campanhaData.topicos.length > 0 && (
                      <div className="pt-1">
                ...
                {message.isDraft && (
                  <div className="pt-2 border-t border-neutral-200">
                    ...
                    <p className="text-[9px] text-neutral-500 leading-relaxed">
                      "Mude o título para...", "Adicione horário...", "Local:
                      ESF Catalão", "Público: gestantes", "Marcar como urgente",
                  ...
                  <div className="flex gap-2">
                    ...
                    {message.inputField.canSkip && (
                      <button
                        ...
                        onClick={() =>
                          onButtonClick &&
                          onButtonClick({ id: "skip", value: "skip" }, message)
                        }
                ...
                <div className="space-y-2">
                  ...
                  {message.inputField.maxLength && (
                    <p className="text-xs text-gray-500">
                      {inputValue.length}/{message.inputField.maxLength}{" "}
                      caracteres
                    </p>
                  )}
                  <div className="flex gap-2">
