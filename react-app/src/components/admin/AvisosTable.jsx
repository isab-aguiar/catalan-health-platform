        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-4 py-2 border border-slate-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm bg-white"
            >
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    {aviso.exibirNaHomepage ? (
                      <span className="inline-flex px-3 py-1 bg-green-100 text-green-800 border border-green-200 rounded-md text-xs font-semibold">
                        Público
                      </span>
                    ) : (
                      <span className="inline-flex px-3 py-1 bg-slate-100 text-slate-700 border border-slate-200 rounded-md text-xs font-semibold">
                        Rascunho
                      </span>
                    )}
                  </td>
