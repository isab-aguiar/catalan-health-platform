...
// =========================================
// Cabeçalho superior do painel administrativo
    ...
    <div className="px-4 sm:px-6 lg:px-8 h-16">
      <div className="flex items-center justify-between h-full">
        ...
        <div className="lg:hidden flex items-center gap-2 mx-auto">
          ...
          <h1 className="text-base font-bold text-slate-900">ESF Catalão</h1>
        </div>
        ...
        <div className="hidden sm:flex items-center gap-3">
          <div className={`w-10 h-10 rounded-md flex items-center justify-center border border-slate-300 ${permissions.getRoleColor()}`}>
          ...
          <span className={`ml-2 text-xs font-semibold px-3 py-1.5 rounded-md border ${permissions.getRoleColor()}`}>
