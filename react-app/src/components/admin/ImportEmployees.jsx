...
} from "../../scripts/importEmployeesToFirestore";
...
export default function ImportEmployees() {
  ...
  const handleImport = async () => {
    if (
      !window.confirm(
        "Deseja importar todos os 48 funcionários para o Firestore? Esta ação irá sobrescrever dados existentes com o mesmo ID."
      )
    ) {
      return;
    }
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-900">
              Importar Funcionários para Firestore
            </h2>
            <p className="text-sm text-gray-600">
              Migração de dados do employees.js para o Firebase
            </p>
          </div>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <ul className="text-sm text-blue-800 space-y-1">
                <li>
                  • Este componente importa todos os 48 funcionários do arquivo
                  employees.js
                </li>
                <li>
                  • Os dados serão salvos na collection "employees" do Firestore
                </li>
                <li>
                  • Funcionários com o mesmo ID serão atualizados (não
                  duplicados)
                </li>
                <li>
                  • Este é um processo seguro e pode ser executado múltiplas
                  vezes
                </li>
              </ul>
            </div>
