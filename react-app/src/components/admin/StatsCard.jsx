...
// =========================================
// Componente para exibição de métricas e estatísticas
    ...
    <div className="bg-white rounded-md p-4 sm:p-6 shadow-sm border border-slate-300 hover:shadow-md transition-shadow">
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          ...
          {trend && (
            <div className={`inline-flex items-center gap-1 mt-2 sm:mt-3 text-xs font-medium ${
        ...
        <div className={`w-12 h-12 sm:w-14 sm:h-14 ${bgColor} bg-opacity-10 rounded-md flex items-center justify-center flex-shrink-0 border border-slate-200`}>
