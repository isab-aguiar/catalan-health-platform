  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-neutral-200 p-3 md:p-6 hover:shadow-md transition-all duration-300 animate-fade-in">
      <div className="flex items-start justify-between mb-2 md:mb-4">
        <div
          className={`w-8 h-8 md:w-12 md:h-12 ${bgColor} rounded-lg flex items-center justify-center shadow-sm flex-shrink-0`}
        >
      ...
      <div>
        <p className="text-xs md:text-sm text-neutral-600 mb-1 truncate">
          {title}
        </p>
