...
/**
 * Componente de filtros avançados para o calendário
 */
export default function CalendarFilters({ filters, onFiltersChange, eventCounts }) {
  ...
  const FilterChip = ({ icon: Icon, label, count, active, onClick, colorClass }) => (
    <button
      onClick={onClick}
      className={`
    ...
    <div className="bg-white rounded-lg shadow-sm border border-neutral-200 p-4 space-y-4">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="text-xs text-neutral-600 mb-1 block">Data Início</label>
            <input
              type="date"
          ...
          <div>
            <label className="text-xs text-neutral-600 mb-1 block">Data Fim</label>
            <input
              type="date"
