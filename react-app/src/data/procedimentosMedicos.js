...
export const procedimentosMedicos = {
  ...
  "audiometria-tonal-vocal": {
    ...
    documentosNecessarios: [
      "Documentos pessoais (1 cópia)",
      "Encaminhamento médico (1 cópia)",
    ],
    observacoes: [],
    filaUnica: false,
  },
  "audiometria-campo-livre": {
    ...
    documentosNecessarios: [],
    observacoes: [
      "Serviço temporariamente indisponível - sem prestador credenciado",
    ],
    filaUnica: false,
    semPrestador: true,
  },
  ...
  "caps-psiquiatria-infantil": {
    ...
    local: "Protocolar na Unidade",
    orientacoes: ["Protocolar na unidade de saúde"],
  ...
  "diu-planejamento-familiar": {
    ...
    documentosNecessarios: ["Preventivo recente", "B-HCG (máximo 48 horas)"],
    observacoes: [],
    filaUnica: true,
  },
  "infectologista-sae": {
  ...
  ginecologia: {
    ...
    orientacoes: ["Agendar atendimento na Sala de Agendamentos"],
    documentosNecessarios: ["Encaminhamento médico"],
    observacoes: [],
    filaUnica: false,
  },
  ...
  "consulta-ginecologica-detalhada": {
    ...
    observacoes: [
      "Destinado a pré-natal, primeira consulta, retornos ou encaminhamentos",
    ],
    servicosOferecidos: [
  ...
  "primeira-consulta-pre-natal": {
    ...
    observacoes: [
      "Primeira consulta deve ser realizada até a 12ª semana de gestação",
    ],
    filaUnica: false,
  },
  "cronograma-pre-natal": {
    ...
    local: "Sala de Agendamentos",
    orientacoes: [
      "1ª consulta: até a 12ª semana com a enfermeira",
      "2ª consulta: 20ª semana com médico",
      "3ª consulta: 26ª semana com enfermeira",
      "4ª consulta: 30ª semana com médico",
      "5ª consulta: 36ª semana com enfermeira",
...
export const informacoesAdicionais = {
  ...
  fisioterapiaCrer: {
    ...
    tipos: ["Fisioterapia pós-operatório", "Sequela de AVC", "Fraturas"],
  },
  "consultorio-odontologico": {
    ...
    documentosNecessarios: [
      "Documento de identificação com foto do titular (RG, CNH ou Carteira de Trabalho)",
    ],
    observacoes: [
