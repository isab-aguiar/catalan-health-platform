 ...
 * Port direto do smart_search.js original para manter compatibilidade 100%
 *
 * @param {string} str - String para normalizar
 * @returns {string} String normalizada (sem acentos, minúsculas, trim)
 *
 * @example
 * normalize("Rua José de Alencar") // "rua jose de alencar"
 * normalize("Avenida Paraná")      // "avenida parana"
 */
export function normalize(str) {
  if (!str) return '';

  return str
    .normalize('NFD')                    // Decomposição NFD (separa acentos)
