...
const CAMPAIGN_STEPS = {
  ...
  description: {
    ...
    rows: 4,
    placeholder:
      "Ex: a vacina da gripe tá disponível pra todo mundo. é de graça e tem pra toda idade",
  ...
  image_adjust: {
    ...
    buttons: [
      ...
      {
        id: "add_more",
        label: "📷 Adicionar mais imagens",
        value: "add_more",
        variant: "secondary",
      },
      {
        id: "reorder",
        label: "↻ Reordenar imagens",
        value: "reorder",
        variant: "secondary",
      },
    ],
  ...
  refine_menu: {
    ...
    buttons: [
      ...
      {
        id: "edit_extra",
        label: "ℹ️ Editar Informações Extras",
        value: "extra_info",
      },
    ...
    (stepId, userInput) => {
      const stepIdString =
        typeof stepId === "string"
          ? stepId
          : stepId?.id || stepId?.stepId || String(stepId);
      if (!stepIdString) {
      ...
      if (step.field && userInput !== null && userInput !== undefined) {
        const valueToSave =
          userInput === "" && !step.required ? null : userInput;
