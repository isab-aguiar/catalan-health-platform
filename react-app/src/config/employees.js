    ...
    employees: [
      ...
      },
      {
        ...
        weeklySchedule: {
          ...
          quinta: {
            morning: "Demanda espontânea",
            afternoon: "Primeiro pré-natal / puerperal",
          },
          sexta: {
            morning: "Demanda espontânea",
            afternoon: "Visita domiciliar",
          },
        },
        contact: { phone: null, email: null },
        firebaseUid: null,
      ...
      },
      {
        ...
        weeklySchedule: {
          ...
          quinta: {
            morning: "Demanda espontânea",
            afternoon: "Pré-natal + Puerperal",
          },
          sexta: {
            morning: "Demanda espontânea",
            afternoon: "Reunião de equipe",
          },
        },
        contact: { phone: null, email: null },
        firebaseUid: null,
      ...
      },
      {
        ...
        schedule: {
          morning: {
            ...
            display: "07h00 às 11h30",
            enabled: true,
          },
          afternoon: {
            start: "12h30",
            end: "16h00",
            display: "12h30 às 16h00",
            enabled: true,
          },
        },
        weeklySchedule: {
  ...
  tecnicoEnfermagem: {
    ...
    employees: [
      ...
      },
      {
        ...
        workStation: {
          morning: {
            location: "Triagem (07:00-08:00) / Sala de Procedimentos",
          },
...
export const getEmployeeById = (employeeId) => {
  for (const dept in employees) {
    const employee = employees[dept].employees?.find(
...
export const getEmployeesByEsf = (esfCode) => {
  ...
  for (const dept in employees) {
    const filtered =
      employees[dept].employees?.filter((emp) => emp.esf === esfCode) || [];
...
export const getEmployeesByRole = (role) => {
  ...
  for (const dept in employees) {
    const filtered =
      employees[dept].employees?.filter((emp) => emp.role === role) || [];
    result.push(...filtered);
  }
  return result;
};
...
export const getSaudeNaHoraEmployees = () => {
  ...
  for (const dept in employees) {
    const filtered =
      employees[dept].employees?.filter((emp) => emp.isSaudeNaHora === true) ||
      [];
    result.push(...filtered);
  }
  return result;
